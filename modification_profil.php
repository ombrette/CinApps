    ...
    <div class="row">
        ...
        <form id="contact" method="post" action="#">
            <legend>MODIFIER :</legend>
                <p><label for="nom">Changer son adresse e-mail</label><br><input type="text" id="nom" name="nom" placeholder="nouveau@gmail.com" /></p>

         
                <p><label for="objet">Changer de mot de passe :</label><br><input type="text" id="objet" name="objet" placeholder="ancien mot de passe" /></p>
                <p><input type="text" id="objet" name="objet" placeholder="nouveau mot de passe" /></p>
            
            <div class="boutonfdj"><input type="submit" name="envoi" value="Confirmer" /></div>
            <p class="boutonfdj"><a href="#">Annuler</a></p>
