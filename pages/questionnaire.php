...
<?php if($film==1) : ?>
<div class="container finquest marg-top">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">       
        <h1 class="text-uppercase titre-section">Fin du questionnaire</h1>
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-10 col-lg-offset-1">
                    <p>Suggestion : Voici le résultat listant les films que nous te suggérons suite à tes réponses, tu n'as plus qu'à choisir !</p>
                </div>
                <?php foreach($reponses as $reponse): ?>
                <div class="col-xs-12 col-sm-4 col-lg-4">
                    <a href="fiche_film.php?id=<?= $reponse['id']; ?>">
                        <h2 class="nomdefilm text-center"><?= $reponse['titre']; ?></h2>
                    <div id="tailleaffiche">   
                        <img src="<?= $reponse['affiche']; ?>" class="img-responsive center-block" width="270" height="360">
                    </div> 
                    </a> 
